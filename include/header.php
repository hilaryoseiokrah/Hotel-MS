<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font text-danger" href="../view/index.php">Ame Stays</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active me-2" aria-current="page" href="../view/index.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link me-2" href="../view/rooms.php">Rooms</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link me-2" href="../view/services.php">Services</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link me-2" href="../view/reachus.php">Contact Us</a>
                </li>


            </ul>
            <div class="d-flex">
                <button type="button" class="btn btn-outline-light shadow-none me-lg-2 me-3 custom-bg" data-bs-toggle="modal" data-bs-target="#loginModal">Login</a>
            </div>

            <div class="d-flex">
                <button type="button" class="btn btn-outline-light shadow-none me-lg-2 me-3 custom-bg" data-bs-toggle="modal" data-bs-target="#registerModal">Register</a>
            </div>
